...
export const EventDetails = ({
  ...
  return (
    <div
      {...props}
      className={`${props.className} flex sm:flex-col items-start w-[50%] md:w-full p-7 sm:p-5 rounded-[20px]`}
    >
      <div className='mt-3 flex flex-1 flex-col items-start self-center'>
        <Text
          as='p'
        ...
        <div className='ml-1.5 mt-9 flex flex-col items-start gap-3 self-stretch sm:ml-0 sm:gap-3'>
          <Text size='textxs' as='p' className='!font-inter tracking-[1.50px] !text-white-a700'>
            {whatToDoSubtitle}
          </Text>
          <Text
            as='p'
        ...
        <Button
          ...
          className='mr-[78px] mt-6 flex h-[60px] min-w-[250px] flex-row items-center justify-center gap-[34px] self-end rounded-lg bg-white-a700 pl-[34px] pr-6 text-center text-[16px] font-bold text-gray-900 sm:mr-0 sm:px-5 sm:text-[13px]'
        >
          {eventButton}
        </Button>
      </div>
      <div className='flex w-[10%] flex-col items-center justify-center rounded-lg bg-white-a700 py-2.5'>
        <Heading
          as='h6'
          className='text-center uppercase leading-5 tracking-[1.80px] !text-black-900 sm:text-[15px]'
        >
          {eventDate}
        </Heading>
      </div>
