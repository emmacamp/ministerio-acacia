            ...
            <div className='flex flex-col gap-8'>
              <div className='flex flex-col gap-5'>
                <div className='flex flex-col items-start gap-4'>
                  <Button
                    className={`${workSans.className} flex h-[32px] min-w-[92px] flex-row items-center justify-center rounded-lg bg-light_blue-700 px-3 text-center  text-[14px] font-medium text-white-a700`}
                  >
                    {blog?.buttonLabel}
                  </Button>
                ...
                <div className='flex'>
                  <Text
                    size='textxs'
                    as='p'
                    className={`${workSans.className} self-end !text-gray-600`}
                  >
                    {blog?.dateText}
                  </Text>
                </div>
              ...
              <div className='flex flex-col gap-[30px]'>
                ...
                />
                <Text size='textlg' as='div' className=' leading-8 !text-gray-800'>
                  <div
                ...
                {blog?.content.subjects.map((subject, i) => (
                  <div key={`subject-${i}`} className='flex flex-col items-start gap-3.5'>
                    ...
                    <Text size='textlg' as='div' className='w-full  leading-8 !text-gray-800'>
                      <div
                        className='leading-8 !text-gray-800'
