          ...
          <div className="flex w-full items-center gap-[30px] rounded-[40px] bg-white-a700 px-[42px] py-[46px] md:flex-col md:p-5">
            ...
            <div className="flex flex-1 flex-col items-center gap-6 md:self-stretch">
              ...
              <Text size="textxs" as="p" className="w-full !font-inter leading-9 tracking-[2.55px]">
                ...
                <span>
                  &nbsp;se centra en transformar vidas mediante el poder del Espíritu Santo. Su propósito es guiar a las
                  personas hacia una&nbsp;
                </span>
                <span className="font-bold">relación profunda con Dios</span>
                <span>
                  <>
                    , ofreciendo salvación y restauración espiritual. Además, se enfoca en empoderar a cada individuo
                    para que descubra y viva su propósito divino, inspirando una vida llena de fe y acción.
                    <br />
                    En cuanto a su&nbsp;
                  </>
                </span>
                ...
                <span className="font-bold">
                  manifestación palpable de Dios, extendiendo su gloria por todo el mundo. Se comprometen a ser testigos
                  fieles y a capacitar a nuevas generaciones de líderes proféticos que continuarán esta misión,
                  asegurando que el mensaje de Dios siga siendo compartido con pasión y propósito.
                </span>
              </Text>
            </div>
          </div>
