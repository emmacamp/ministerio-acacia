        ...
        <div className="container-xs flex justify-center px-14 md:px-5">
          <div className="flex w-[78%] flex-col items-center gap-12 md:w-full">
            <div className="flex flex-col gap-6 self-stretch">
              <Heading size="headingxl" as="h1" className="text-center leading-[72px] tracking-[-2.40px]">
                Transformando Vidas, Impactando al Mundo
              </Heading>
              <Heading as="h2" className="text-center !font-bold leading-[26px]">
                Llevamos la gloria de Dios a cada rincón del mundo, inspirando vidas a través de la fe y la esperanza.
              </Heading>
            </div>
