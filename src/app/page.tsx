...
const HomePage = () => {
  const { count, decrement, increment, reset } = storeCounter();
  return (
    <div>
        ...
        <div className='mx-auto grid max-w-screen-xl px-4 py-8 text-center lg:py-16'>
          <div className='mx-auto place-self-center'>
            <h1 className='mb-4 max-w-2xl text-4xl font-extrabold leading-none tracking-tight dark:text-white md:text-5xl xl:text-6xl'>
              probando vacanamente 2
            </h1>
            <p className='mb-6 max-w-2xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl'>
              Boilerplate and Starter for Next.js, Tailwind CSS and TypeScript ⚡️ Made with
              developer experience first: Next.js, TypeScript, ESLint, Prettier, Husky, Lint-Staged,
              Jest, React Testing Library, PostCSS, Tailwind CSS, Storybook, Plop, GH actions.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className='mx-auto mt-8 max-w-md p-6 bg-white rounded-lg shadow-md dark:bg-gray-800'>
        <h2 className='text-2xl font-bold mb-4 text-center dark:text-white'>Counter</h2>
        <div className='flex justify-center items-center space-x-4'>
          ...
          <span className='text-2xl font-bold dark:text-white'>{count}</span>
          <button
            onClick={increment}
